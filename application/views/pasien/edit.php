                ...
                <?php echo form_open('pasien/edit');?>
                  <div class="box-body">
                    <div class="form-group">
                         <input type="hidden" name="id" value="<?php echo $record['id_pasien']?>">
                    </div>
                      <div class="form-group">
                    </div>
                      <div class="form-group">
                      <label for="exampleInputPassword1">Nama Pasien</label>
                      <input type="text" name="nama" required="" class="form-control" placeholder="Masukan Nama Pasien" value="<?php echo $record['nama']?>">
                    </div>
                       <div class="form-group">
                      <label for="exampleInputPassword1">No Telp</label>
                      <input type="text" name="no_telp" required="" class="form-control" placeholder="Masukan Nama Pasien" value="<?php echo $record['no_telp']?>">
                    </div>
                     <div class="form-group">
