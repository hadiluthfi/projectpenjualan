      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
             <li class="header" style='color:#fff; text-transform:uppercase; border-bottom:2px solid #00c0ef'>MENU DASHBOARD</li>
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-bars"></i><span>RIWAYAT PEMERIKSAAN</span>
                    <i class="fa fa-angle-double-left"></i>
                </a>
                <ul class="treeview-menu">
                    
                    <li>
                     <?php echo anchor('periksa/tindakan_pasien','<i class="fa fa-home"></i> <span>TINDAKAN PASIEN</span>'); ?>
                    </li>
                    
                   <li>
                    <?php echo anchor('periksa/riwayat_periksa','<i class="fa fa-home"></i> <span>RIWAYAT PEMERIKSAAN</span>'); ?>
                  </li>
